...
const c_draggable_m_dragging_BackgroundColor_1 = tslib_1.__importDefault(require('@patternfly/react-tokens/dist/js/c_draggable_m_dragging_BackgroundColor'));
...
const Draggable = (_a) => {
    ...
    const onDragStart = (ev) => {
        ...
        style = Object.assign(Object.assign({}, style), { top: rect.y, left: rect.x, width: rect.width, height: rect.height, [c_draggable_m_dragging_BackgroundColor_1.default.name]: getInheritedBackgroundColor(dragging), position: 'fixed', zIndex: 5000 });
        setStyle(style);
        // Store event details
        startX = ev.pageX;
        startY = ev.pageY;
