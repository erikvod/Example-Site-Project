...
export declare const Wizard: {
    ({ children, footer, height, width, className, header, nav, navAriaLabel, startIndex, isVisitRequired, isProgressive, onStepChange, onSave, onClose, ...wrapperProps }: WizardProps): React.JSX.Element;
    displayName: string;
};
